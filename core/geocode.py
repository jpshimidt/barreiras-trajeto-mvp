...
Três defesas contra o pin cair no distrito errado:

1. o endereço é interpretado no padrão Google Maps (rua, número, bairro, CEP);
2. candidatos genéricos ("São Paulo, Brazil") são descartados e os demais pontuados;
3. quando ninguém pontua bem o suficiente, a interface obriga escolha explícita.
"""
